...
export default function Logo({ className, showText = true }: LogoProps) {
  return (
    <a
      href="/"
      className={twMerge(
        'm-0 text-black dark:text-white flex gap-3 items-center w-fit',
        className
      )}
    >
      <svg
      ...
      >
        <mask
          ...
          height="41"
        >
          <path d="M27.3132 0H0V40.489H27.3132V0Z" fill="white" />
        </mask>
        <g mask="url(#mask0_15_3)">
          <path d="M19.3835 25.3852C19.3835 25.1269 19.5259 24.8891 19.7546 24.7653L26.1673 21.2949C26.6421 21.038 27.2212 21.3786 27.2212 21.9149V36.3114C27.2212 36.5698 27.0789 36.8075 26.8501 36.9313L20.4375 40.4016C19.9627 40.6586 19.3835 40.318 19.3835 39.7818V25.3852Z" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          />
          <path d="M4.16694e-05 4.9988C4.16694e-05 4.76409 0.117668 4.54472 0.3139 4.41341L6.72648 0.122106C7.19975 -0.194571 7.83768 0.141521 7.83768 0.707498V14.0056C7.83768 14.2403 7.72005 14.4597 7.52378 14.5911L1.11119 18.8823C0.637968 19.199 0 18.8629 0 18.297L4.16694e-05 4.9988Z" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
      ...
      {showText && <span className="font-bold text-2xl">Hyperce</span>}
    </a>
  );
}
