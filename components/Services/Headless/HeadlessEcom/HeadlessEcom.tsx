        ...
        <div className="lg:w-3/5 flex flex-col gap-10 text-lg">
          ...
          <p>
            ...
            <p>
              ...
              shattered the limitations of traditional eCommerce, carving a path
              to the future with headless commerce solutions that are as
              ...
              scalability. It&apos;s a revolution in eCommerce that speaks to
              the hearts of both clients and savvy entrepreneurs.
            </p>
          </p>
        </div>
        <div className="lg:w-2/5 grid md:grid-cols-2 gap-5 h-fit">
          ...
          <div className="md:col-span-2 flex justify-center">
            <div className="bg-gray-200 dark:bg-[#172D41] md:w-1/2 h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
              ...
              <p className=" text-black dark:text-[#CBCBCB] text-sm">
                Picture a canvas where your creativity knows no bounds.
                Customize your storefront to match your brand&apos;s unique
                essence.
              </p>
            </div>
          </div>
