    ...
    <section className="container mx-auto px-10 py-20 text-black dark:text-white">
      ...
      <div className="flex gap-20 flex-col lg:flex-row">
        ...
        <div className="lg:w-2/5 grid grid-cols-2 gap-5">
          <div className="bg-[#172D41] h-fit px-5 py-5 gap-5 flex flex-col rounded-xl">
            <svg
              width="45"
              height="45"
              viewBox="0 0 87 90"
          ...
          <div className="col-span-2 bg-[#172D41] h-fit px-10 py-5 gap-5 flex rounded-xl items-center justify-between xl:w-2/3">
            <svg
              width="60"
              height="60"
              viewBox="0 0 87 90"
