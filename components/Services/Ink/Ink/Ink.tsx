    ...
    >
      <div className="flex flex-col md:text-center gap-5 md:items-center text-black dark:text-[#CECFDF] mb-20">
        ...
        <p className="w-2/3 text-base">
          ...
          blogging website services can help you weave enchanting narratives
      ...
      <div className="flex gap-20 flex-col lg:flex-row">
        ...
        <div className="lg:w-2/5 grid grid-cols-2 gap-5 h-fit">
          ...
          <div className="col-span-2 bg-gray-200 dark:bg-[#172D41] h-fit px-10 py-5 gap-5 flex rounded-xl items-center justify-between">
            <svg
            ...
            <p className=" text-black dark:text-[#CBCBCB] w-4/5 text-sm">
              We position your business as a thought leader in your industry.
              Our blogs showcase your expertise, providing valuable insights
              that draw in not only customers but also potential business
              partners who recognize your authority.
            </p>
          </div>
        </div>
      </div>
