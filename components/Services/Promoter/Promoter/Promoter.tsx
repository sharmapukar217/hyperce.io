    ...
    >
      <div className="flex flex-col md:text-center gap-5 md:items-center text-black dark:text-[#CECFDF] mb-20">
        <p className="leading-wide text-2xl font-extrabold">
          Elevate your brand with Hyperce: Where promotion meets perfection.
        </p>
        <p className="w-2/3 text-base">
          Promotion services are a vital component of marketing and advertising
          strategies, aimed at increasing brand visibility, attracting potential
          customers, and driving sales or engagement.
        </p>
      </div>
      ...
      <div className="flex gap-20 flex-col lg:flex-row">
        <div className="lg:w-3/5 flex flex-col gap-10 text-lg">
          ...
          <p>
            ...
            exceptional and unrivaled service. We don&apos;t just work with any
            influencers; we meticulously curate a network of promoters who align
            perfectly with your brand and audience. It&apos;s not about reaching
            everyone; it&apos;s about getting the right ones.
          </p>
          <p>
            <p className="font-bold">Our mission? </p>
            <br />
            <p>
              Our mission at Hyperce is to empower businesses to achieve
              unparalleled success in the ever-evolving digital landscape. We
              harness the power of innovative marketing strategies, influencer
