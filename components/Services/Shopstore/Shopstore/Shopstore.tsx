    ...
    >
      <div className="flex flex-col md:text-center gap-5 md:items-center text-black dark:text-[#CECFDF] mb-20">
        <p className="leading-wide text-2xl font-extrabold">
          Hyperce ShopStore: Uplifting E-Commerce Distinction
        </p>
        <p className="w-2/3 text-base">
          Hyperce ShopStore is your premier e-commerce partner, offering a
          comprehensive suite of services to establish, enhance, and elevate
          your online retail presence. From strategic platform consultations to
        ...
        <div className="lg:w-2/5 grid md:grid-cols-2 gap-5 h-fit">
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            ...
            <p className=" text-black dark:text-[#CBCBCB] text-sm">
              Streamline your delivery pipeline and minimize manual intervention
              through our Continuous Integration and Continuous Deployment
              practices, boosting development efficiency.
            </p>
          </div>
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            <svg
            ...
            <p className=" text-black dark:text-[#cbcbcb] text-sm">
              ...
              with Infrastructure as Code, ensuring consistent and scalable
              environments for your online store.
            </p>
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="bg-gray-200 dark:bg-[#172D41] md:w-1/2 h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
              ...
              <p className=" text-black dark:text-[#CBCBCB] text-sm">
                Foster team collaboration and communication by leveraging our
                integrated tooling and practices.
              </p>
            </div>
          </div>
        </div>
