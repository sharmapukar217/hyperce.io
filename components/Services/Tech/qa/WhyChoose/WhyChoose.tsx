      ...
      <div className="bg-gray-200 dark:bg-gradient-to-r from-[#101525] to-[#212642] md:px-10 rounded-3xl pt-16">
        <div className="flex items-center flex-col gap-5">
          ...
          <p className="w-3/4 text-base md:text-xl text-center">
            Boost your software&apos;s potential with Hyperce QA - the go-to
            solution for thorough and adaptable testing services. Rely on our
            robust security measures, seamless scalability, and top-notch
            performance testing to ensure your software excels in the digital
            realm. Count on our dedicated support and hassle-free management to
            strengthen your software and drive your business toward unmatched
            success. Trust Hyperce QA for reliable software excellence and
            accelerated growth.
          </p>
        </div>
