...
import { PromoterGallary } from '@/data/Gallary/Promoter';

export default function PromoterGallaryComponent() {
  ...
  return (
    <section className="container mx-auto px-10 flex flex-col gap-5 md:px-20 py-10 md:py-20">
      <div className="text-center md:pb-10 flex flex-col gap-2">
