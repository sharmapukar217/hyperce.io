    ...
    >
      <div className="flex flex-col md:text-center gap-5 md:items-center text-black dark:text-[#CECFDF] mb-20">
        <p className="leading-wide text-2xl font-extrabold">
          Hyperce DevOps: Revolutionizing the Software Deployment Landscape
        </p>
        <p className="w-2/3 text-base">
          Hyperce DevOps offers a comprehensive suite of DevOps services
          designed to optimize your software development lifecycle. We ensure
          seamless collaboration between development and operations teams,
          resulting in faster, more reliable releases. Experience a
          transformative approach to software development that empowers your
          team to deliver high-quality applications with efficiency and
          precision.
        </p>
      </div>
      ...
      <div className="flex gap-20 flex-col lg:flex-row">
        <div className="lg:w-3/5 flex flex-col gap-10 text-lg">
          <p className="text-4xl font-bold">What is Hyperce Devops ?</p>
          <p>
          ...
          <p>
            ...
            <br />
            <p>
              Our mission is to revolutionize the way software is developed and
              ...
              holistic approach not only ensures faster and more reliable
              releases but also enhances collaboration, driving your team
        ...
        <div className="lg:w-2/5 grid md:grid-cols-2 gap-5 h-fit">
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            ...
            <p className=" text-black dark:text-[#CBCBCB] text-sm">
              Maximize development efficiency with our Continuous Integration
              and Continuous Deployment practices, streamlining the delivery
              pipeline and reducing manual intervention.
            </p>
          </div>
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            <svg
            ...
            <p className=" text-black dark:text-[#cbcbcb] text-sm">
              Implement Infrastructure as Code to automate the provisioning and
              management of infrastructure, resulting in consistent and scalable
              environments.
            </p>
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="bg-gray-200 dark:bg-[#172D41] md:w-1/2 h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
              ...
              <p className=" text-black dark:text-[#CBCBCB] text-sm">
                Enhance team collaboration and communication through our
                integrated tooling and practices, ensuring seamless coordination
