    ...
    >
      ...
      <div className="flex gap-20 flex-col lg:flex-row">
        <div className="lg:w-3/5 flex flex-col gap-10 text-lg">
          <p className="text-4xl font-bold">What is Hyperce Security ?</p>
          <p>
            Hyperce Security is the cornerstone of your digital defense
            strategy. Our suite of security practices, including Web Application
            Firewall (WAF), DDoS Protection, End-to-End Encryption, Penetration
            Testing, Security Audits, PCI DSS Compliance, Multi-Factor
            Authentication (MFA), Secure Code Review, Intrusion Detection and
            Prevention Systems (IDPS), and Data Backup and Disaster Recovery,
            ensures comprehensive protection for your online presence.
          </p>
          <p>
            <p className="font-bold">Our mission? </p>
            <br />
            <p>
              Our mission is to fortify your digital presence and ensure
              ...
              holistic approach not only safeguards your digital assets but also
              enhances compliance, driving your organization towards
        ...
        <div className="lg:w-2/5 grid md:grid-cols-2 gap-5 h-fit">
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            ...
            <p className=" text-black dark:text-[#CBCBCB] text-sm">
              Conduct Secure Code Review, analyzing the application codebase for
              security flaws and providing recommendations for secure coding
              practices.
            </p>
          </div>
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            ...
            <p className=" text-black dark:text-[#cbcbcb] text-sm">
              Ensure robust Data Backup and Disaster Recovery with regular
              automated backups and rapid restoration capabilities in the event
              of data breaches or loss.
            </p>
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="bg-gray-200 dark:bg-[#172D41] md:w-1/2 h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
              ...
              <p className=" text-black dark:text-[#CBCBCB] text-sm">
                Maintain PCI DSS Compliance to ensure your online store meets
                the Payment Card Industry Data Security Standard, which is
                mandatory for sites that process credit card transactions.
              </p>
            </div>
          </div>
        </div>
