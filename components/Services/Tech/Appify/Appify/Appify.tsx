export default function Appify() {
  return (
    <section
    ...
    >
      <div className="flex flex-col md:text-center gap-5 md:items-center text-black dark:text-[#CECFDF] mb-20">
        <p className="leading-wide text-2xl font-extrabold">
          Hyperce Appify: Elevating Mobile Experience Beyond Limits
        </p>
        <p className="w-2/3 text-base">
          Hyperce Appify is a catalyst that specializes in elevating your
          e-commerce experience through seamlessly crafted mobile apps. Our
          dedication to intuitive interfaces and robust shopping functionalities
          ensures that your business seamlessly ventures into the mobile space,
          enhancing the journey for your customers.
        </p>
      </div>

      <div className="flex gap-20 flex-col lg:flex-row">
        <div className="lg:w-3/5 flex flex-col gap-10 text-lg">
          <p className="text-4xl font-bold">What is Hyperce Appify ?</p>
          <p>
            While rooted in e-commerce, Hyperce Appify offers versatility
            without limits, empowering small businesses, service providers, and
            visionary entrepreneurs to bring their unique ideas to life. The
            user-friendly interface eliminates the daunting aspects of app
            development; you can be something other than a coding expert. With
            the Hyperce Appify, creativity is unleashed without technical
            hurdles. At its core, customization defines our platform.
          </p>
          <p>
            ...
            <p>
              ...
              <br />
              <br />
              Tailor every aspect, from design elements to functionalities, to
              ensure your app mirrors your brand identity and meets specific
              business requirements. Hyperce Appify is more than an app
        ...
        <div className="lg:w-2/5 grid md:grid-cols-2 gap-5 h-fit">
          ...
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            ...
            <p className=" text-black dark:text-[#cbcbcb] text-sm">
              ...
              recovery capabilities, Hyperce Appify safeguards your data,
          ...
          <div className="md:col-span-2 flex justify-center">
            <div className="bg-gray-200 dark:bg-[#172D41] md:w-1/2 h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
              ...
              <p className=" text-black dark:text-[#CBCBCB] text-sm">
                Maintain PCI DSS Compliance: Hyperce Appify prioritizes the
                security of online transactions by adhering to the Payment Card
                Industry Data Security Standard (PCI DSS), ensuring a secure
