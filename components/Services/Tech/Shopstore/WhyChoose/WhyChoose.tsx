      ...
      <div className="bg-gray-200 dark:bg-gradient-to-r from-[#101525] to-[#212642] md:px-10 rounded-3xl pt-16">
        <div className="flex items-center flex-col gap-5">
          ...
          <p className="w-3/4 text-base md:text-xl text-center">
            ...
            digital storefront is more than just a collection of products;
            it&apos;s an immersive experience for your customers.
            <br />
            <br /> Thus, our e-commerce development solutions extend beyond the
            technicalities to encompass the artistry of design. Whether
            it&apos;s the creation of a new store or the migration between
            platforms, our custom storefront designs are not just visually
            appealing; they encapsulate the essence of your brand, leaving an
            indelible impression on every visitor, regardless of the device they
            choose. Choose Hyperce ShopStore for a transformative e-commerce
