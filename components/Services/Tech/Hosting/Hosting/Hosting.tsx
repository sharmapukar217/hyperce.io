    ...
    >
      <div className="flex flex-col md:text-center gap-5 md:items-center text-black dark:text-[#CECFDF] mb-20">
        <p className="leading-wide text-2xl font-extrabold">
          Hyperce Hosting: Powering Your Website
        </p>
      ...
      <div className="flex gap-20 flex-col lg:flex-row">
        <div className="lg:w-3/5 flex flex-col gap-10 text-lg">
          <p className="text-4xl font-bold">What is Hyperce Hosting ?</p>
          <p>
            Hyperce Hosting is your gateway to a cutting-edge hosting
          ...
          <p>
            ...
            <br />
            <p>
              Our mission is to set a new standard for eCommerce excellence.
              Through our dedicated eCommerce hosting, we craft bespoke hosting
              environments meticulously calibrated for e-commerce behemoths like
              Magento, WooCommerce, Shopify Plus, and PrestaShop. The symphony
              of our managed cloud hosting unveils a ballet of scalability
              choreographed on esteemed platforms such as AWS, Google Cloud, and
              Azure. Witness the enchantment of auto-scaling, server-side
              caching, and content optimization, fortifying your eCommerce
              venture against every difficulty. Our security architecture forms
              a foundation, safeguarding your hosted sanctums and the invaluable
        ...
        <div className="lg:w-2/5 grid md:grid-cols-2 gap-5 h-fit">
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            ...
            <p className=" text-black dark:text-[#CBCBCB] text-sm">
              Simplify your online store management with secure and dependable
              hosting tailored for diverse eCommerce needs.
            </p>
          </div>
          <div className="bg-gray-200 dark:bg-[#172D41] h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
            <svg
            ...
            <p className=" text-black dark:text-[#cbcbcb] text-sm">
              Effortlessly handle fluctuating online traffic and enhance your
              content for peak performance across digital platforms.
            </p>
          </div>
          <div className="md:col-span-2 flex justify-center">
            <div className="bg-gray-200 dark:bg-[#172D41] md:w-1/2 h-full px-5 py-5 gap-5 flex flex-col rounded-xl">
              ...
              <p className=" text-black dark:text-[#CBCBCB] text-sm">
                Guarantee the security of your business communication with our
                reliable and robust email services, ensuring uninterrupted
