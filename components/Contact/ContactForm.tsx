        ...
        >
          ...
          <div className="mb-5">
            <input
              ...
              className="w-2/3 lg:w-full border px-4 py-3 text-black placeholder:text-gray-800 rounded-md outline-none focus:outline-gray-400 bg-white"
              name="name"
              value={formData.name}
          ...
          <div className="mb-3">
            <textarea
              ...
              className="text-black w-2/3 lg:w-full border px-4 py-3 placeholder:text-gray-800 rounded-md outline-none h-36 focus:outline-gray-400 bg-white"
