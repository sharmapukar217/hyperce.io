export default function EachTest(props: any) {
  return (
    <div className="flex flex-col border-2 min-h-max border-gray-200 dark:border-gray-700 dark:hover:bg-[#0F172A] text-black dark:text-white rounded-xl items-center px-4 md:px-8 mt-10 mb:mt-0 pb-5">
