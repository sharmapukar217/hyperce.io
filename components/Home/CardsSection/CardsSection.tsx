      ...
      <div className="">
        <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
          <div className="mx-auto text-center lg:text-left lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-200 text-base">
            ...
            <a
              href="#"
              className="mt-8 inline-block rounded-full bg-[#357D8A] px-6 py-3 text-sm font-medium text-white transition hover:bg-[#2d4d53] hover:scale-[110%] active:scale-[95%]"
            >
              Get Started Today
            </a>
          </div>
