export default function Message() {
  return (
    <section className="mx-auto container flex lg:px-20 justify-center py-20">
      <div className="bg-[#0E1625] w-[80%] flex flex-col lg:flex-row">
        <div className="w-full lg:w-1/2 h-[50vh] bg-cover flex items-end  bg-[url('')]">
          <div className="h-full w-full object-center">
            <img width="100%" height="100%" loading="lazy" className="h-full object-cover w-full" src="/biplab.png" alt="" />
          </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-3 justify-center px-10 py-5">
          <h3 className="text-xl font-semibold text-[#AEF2D7]">
