...
import Security from '@/components/Services/Tech/Security/Security/Security';
import Hero from '@/components/Services/Tech/Security/Hero/Hero';
import WhyChoose from '@/components/Services/Tech/Security/WhyChoose/WhyChoose';
...
export const metadata: Metadata = {
  title: 'Hyperce Security | Best Ecommerce Solution',
  description:
