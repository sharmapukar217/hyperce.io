      ...
      */}
      <body className={`bg-[#ebeeef] dark:bg-[#02080F] ${raleway.className}`}>
        ...
        >
          ...
          <span className="transition-all duration-500 font-bold whitespace-nowrap group-hover:pl-2 w-0 opacity-0 group-hover:opacity-100 group-hover:w-40">
            Chat on WhatsApp
          </span>
        </a>
        <Script
